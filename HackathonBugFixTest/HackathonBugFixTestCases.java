...
public class HackathonBugFixTestCases {
	...
	static final String SORTED_TEXT_N = System.lineSeparator() + "@" + System.lineSeparator() + "-1"
			+ System.lineSeparator() + "100" + System.lineSeparator() + "A" + System.lineSeparator() + "a"
			+ System.lineSeparator();

	/*
	 * Reported Bug: 01 - Cat: No exception when file is not valid 02 - Cal: No
	 * exception if number argument is more than 3 03 - Cal: No exception if
	 * month is not valid (negative or > 12) 04 - Command substitution: Cat does
	 * not work with echo 05 - grep & sed do not throw exception for null args
	 * 06 - Head, Tail: run correctly and throws exception message when input
	 * negative line numbers 08 - Date: run correctly and also throw exception
	 * on more than 0 input args 09 - Grep: 0 args does not return exception 10
	 * - Grep: Does not throw exception on invalid pattern 11 - Grep: Does not
	 * throw exception for nonexistent file 12 - Sed: return null for correct
	 * case using | as separator 13 - Wc: throw exception when using option +
	 * stdin 14 - Wc: return nothing when using more than 1 options + stdin 15 -
	 * Globbing: run correctly and for nonexistent path, keep ARG and throwing
	 * nonexistent file exception 16 - Globbing: run correctly and asterisk (*)
	 * in quotation is not interpreted as globbing 19 - Sort: numbers (-n
	 * option) wit stdin returns nothing 20 - Pipe: no exception thrown when a
	...
	/*
	 * Fixed Bug No.1 Test for Bug No. 1 "cat" command will throw exception if
	...
	/*
	 * Fixed Bug No.2 Test for Bug No. 2 "cal" command will throw exception if
	 * args is more than 3
	 */
	@Test
	...
	/*
	 * Fixed Bug No.3 Test for Bug No. 3 "cal" command will throw exception if
	 * args is not valid
	 */
	@Test
	...
	/*
	 * Fixed Bug No.5 and 9 Test for Bug No. 5 and 9 "grep" command will throw
	 * exception if args is not null or 0
	 */
	@Test
	...
	/*
	 * Fixed Bug No.5 Test for Bug No. 5 and 9 "sed" command will throw
	 * exception if args is not null or 0
	 */
	@Test
	...
	/*
	 * Fixed Bug No.8 Test for Bug No. 8 "date" command does not accept arg. If
	 * there is no arg the the date and time will be printed
	 */
	@Test
	...
	/*
	 * Fixed Bug No.8 Test for Bug No. 8 Error msg will be thrown when "date"
	 * cmd has an arg
	 */
	...
	/*
	 * Fixed Bug No.10 Test for Bug No. 10 "grep" command will throw exception
	...
	/*
	 * Fixed Bug No.11 Test for Bug No. 11 "grep" command will throw exception
	...
	/*
	 * Fixed Bug No.12 Test for Bug No. 12 "sed" command will handle different
	 * seperators as well
	 */
	@Test
	...
	/*
	 * Fixed Bug No 13 Test for Bug No.13 wc return results when using more than
	 * 1 options + stdin
	 */
	@Test
	...
	/*
	 * Fixed Bug No 14 Test for Bug No.14 wc does not throw exception when using
	 * option + stdin using wc -m -w -l < wc.txt
	 */
	@Test
	...
	/*
	 * Fixed Bug No 14 Test for Bug No.14 wc does not throw exception when using
	 * option + stdin using cat wc.txt | wc -m -w -l
	 */
	@Test
	...
	/*
	 * Fixed Bug No 19 Test for Bug No.19 sort numbers (-n option) with stdin
	 * returns a result using sort -n < sort.txt
	 */
	@Test
	...
	/*
	 * Fixed Bug No 19 Test for Bug No.19 sort numbers (-n option) with stdin
	 * returns a result using cat sort.txt | sort -n
	 */
	@Test
