...
public class SortOrder {
	...
	/**
	 * @param dataList
	 *            ArrayList containing lines to be sorted in ascending ASCII
	 *            value order
	...
	/**
	 * This methods insert the newLine in the correct sorted order of the
	 * ArrayList
	 * 
	 * @param dataList
	 *            ArrayList containing lines to be sorted in ascending ASCII
	 *            value order
	 * @param newLineCharArr
	 *            the new line which is split into a char Array
	 * @param newLine
	 *            the new line to be sorted and inserted into the correct order
	 *            in the Array List
	 * @return ArrayList<String> data sorted in ascending ASCII value order
	 */
