...
public class WcOption {
	 ...
	 * 
	 * @param args array of args return the string option, -l, -w, -m, -lw, -lm,
	 * -wm, -lwm
	 */
	 ...
	 * 
	 * @param option return true if it is a valid option
	 */
	 ...
	 * 
	 * @param isMchar boolean value true/false return either -l, -w, -m, -lw,
	 * -lm, -wm, -lwm
	 */
