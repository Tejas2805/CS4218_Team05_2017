...
public class CdApplication implements Application {
	 ...
	 * 
	 * @param args
	 *            contains an array of arguments such as PATH args does not
	 *            contains "cd" in front, only the PATH is in the args
	 * @param stdin
	...
	private void checkAbsolutePath(String dir) throws CdException {
		if (String.valueOf(dir.charAt(0)).equals(File.separator)) {
			throw new CdException("The directory " + dir + " contains a " + File.separator
					+ " at the front which indicates it is an absoulte path");
		}
	}
	...
	/**
	 * This methods appends a front slash '/' to the front of a directory if the
	 * first char is not a front slash '/'
	 * 
	 * @param dir
	 *            The input directory
