...
public class SortNumber {
	 ...
	 * @param data
	 *            contains the line of data separated by "System.lineSeparator"
	 * @return String data that does not contains a numerical value as the first
	 *         word
	 */
	...
	/**
	 * @param dataList
	 *            ArrayList containing lines to be sorted in numerical order
	...
	/**
	 * This methods sort the line in ascending ASCII value order if the first
	 * word of two lines have the same number
	 * 
	 * @param numList
	 *            ArrayList containing lines to be sorted in numerical order
	 * @param firstLine
	 ...
	 *            the second line
	 * @param index
	 *            the index to place the line in the arraylist
	 * @return ArrayList<String> data sorted in numerical order follows by
	 *         ascending ASCII value if the first two words are same number
	 */
	...
	/**
	 * This methods increase the ASCII value of number (0-9), capital (A-Z) &
	 * simple (a-z)
	 * 
	 * @param char
