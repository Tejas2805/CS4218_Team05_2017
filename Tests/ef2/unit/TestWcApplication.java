...
public class TestWcApplication {
	...
	public void testStdin() throws WcException {
		...
		wcApp.run(null, stdin, stdout);
		assertEquals("   13   2   1" + System.lineSeparator(), stdout.toString());
		stdout = new ByteArrayOutputStream();

		String inStream2 = "hello world";
		stdin = new ByteArrayInputStream(inStream2.getBytes());
		wcApp.run(null, stdin, stdout);
		assertEquals("   11   2   1" + System.lineSeparator(), stdout.toString());
		stdout = new ByteArrayOutputStream();
	}
	...
	/*
	 * Test that printAllCountInFile output the newline, word & char count of
	 * the file
	 */
	@Test
	public void testprintAllCountsInFile() {
		String actual = wcApp.printAllCountsInFile(data);
		assertEquals("   65   10   11", actual);
	...
	/*
	 * Test that printAllCountInStdin output the newline, word & char count of
	 * the file
	 */
	@Test
