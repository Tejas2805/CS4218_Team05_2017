...
public class TestSortOrder {
	...
	/*
	 * Test that sortData(String) sort the line in the order of special char,
	 * numbers, capital letter & simple letters sort.txt contains line in random
	 * order sortAll.txt contains line sorted in the order of special char,
	 * numbers, capital letter & simple letters
	 */
	@Test
	...
	/*
	 * Test that sortByAscii(String) sort the line in the order of special char,
	 * numbers, capital letter & simple letters each individual order(e.g.
	 * special chat, number) is sorted according to ascending ascii value
	 * sort.txt contains line in random order sortAll.txt contains line sorted
	 * in the order of special char, numbers, capital letter & simple letters
	 */
	@Test
